...
// // FIXME: Do-while Loop (It execute atlest one time always whether the consdititon is true or false)
// let m = 0;
// do {
//     console.log(m);
//     m++;
...
// // FIXME: Break (cursor came out of the nearest loop)
// for (let p = 1; p < 10; p++) {
//     if (p%7 === 0) {
...
// // FIXME: Continue (it will take back to the nearest loop)
// for (let r = 0; r < 10; r++) {
//     if (r%3 ===0) {
//         continue;
//     }
...
// FIXME: for-in loop  (by this i can iterate on object)
...
// FIXME: for-of loop (this loop can only use on iterables like Arrays and Maps)